...
An R project is a self-contained working environment with folders for data, scripts, outputs, and more. Learning about R Projects will make your work flow portable and efficient.
...
#### Open a new script
With RStudio open, you can click on the icon under File to open a blank script (below). An untitled script should appear in your RStudio pane that is ready for you to enter commands. Be sure to save this script early and often with a descriptive name in the R project you have created. 

[INSERT SCREENSHOT OF NEW SCRIPT ICON]
