...
```{r quiz}
quiz(
  question("What function can be used to create new columns?",
    answer("select()"),
...
```{r clean_rename_select-hint}
You can use the function ifelse() to carry out different operations based on another value. This function is vectorised and so will run through each row of a column and return an answer.
