...
As you can see, this has only kept the columns with the original names of `r 'infection date'` and `r 'hosp date'` and renamed them. Note, because of the spaces in the names of the dataset we need to put the column name within `r ' '` as R does not like spaces.
