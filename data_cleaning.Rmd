...
Use the R package **linelist** and it’s function `clean_variable_spelling()` to clean a dataframe with a cleaning dictionary. **linelist** is a package developed by RECON - the R Epidemics Consortium.
