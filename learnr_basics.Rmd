...
### Import data from root folder and assign as object {#import-root} 
...
```{r objects}
linelist <- rio::import(here::here("www", "linelist_cleaned.rds"))   # read in data and assign it a name
```

We can check that the data has been properly assigned by running the object name `linelist`. 
