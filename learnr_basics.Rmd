...
pacman::p_load(learnr, here, rio, tidyverse)
...
rio::import(here::here("www", "linelist_cleaned.rds"))
...
```{r objects}
epidata <- rio::import(here::here("www", "linelist_cleaned.rds"))   # read in data and assign it a name
```
