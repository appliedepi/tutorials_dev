...
Labels look much improved by using `geom_label_repel()` from the **ggrepel** package. These scale with the size of the point which we have assigned to number of cases in this plot so we should set size = 5 within `geom_label_repel()` to fix this. 
