...
ggplot(data = linelist, aes(x = age, y = wt_kg))+
  geom_point(aes(color = outcome), size = 2, alpha = 0.5)
```
...
ggplot(data = linelist, aes(x = age, y = wt_kg))+
  geom_point(aes(shape = gender, color = age_cat), size = 3, alpha = 0.3)
```
...
ggplot(data = linelist, aes(x = age, y = wt_kg))+
  geom_point(aes(fill = age_cat), color = "black", shape = 21, size = 3, alpha = 0.3)
```
